...
import PublicacionMScreen from './PublicacionM';

export default function PublicacionM({ navigation, route }) {
  ...
  const handleButtonPress = () => {
    if (selectedImages.length === 0 || description.trim().length < 8) {
      ...
      navigation.navigate('ModaScreen', { newImages: selectedImages, description: description });
    }
  };
