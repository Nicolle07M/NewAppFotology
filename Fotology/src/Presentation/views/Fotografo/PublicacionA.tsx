...
import PublicacionAScreen from './PublicacionA';

export default function PublicacionA({ navigation, route }) {
  ...
  const handleButtonPress = () => {
    if (selectedImages.length === 0 || description.trim().length < 8) {
      ...
      navigation.navigate('AlimentosScreen', { newImages: selectedImages, description: description });
    }
  };
